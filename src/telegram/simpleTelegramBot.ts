  ...
  private setupHandlers() {
    ...
    this.bot.on("message", async (msg) => {
      ...
      try {
        ...
        let conversationId =
          await conversationManager.getActiveConversation(userId);
        ...
        // Заглушка для AI ответа (нужно подключить AIAgent)
        const response =
          "Спасибо за ваше сообщение! Наш консультант скоро с вами свяжется.";
